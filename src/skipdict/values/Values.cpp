...
skipdict::values::ValueCode Value::getCode() const
{
    if (!m_isInitialized)
        throw zserio::CppRuntimeException("Parameter code of compound Value "
                "is not initialized!");

    return m_code;
}

skipdict::values::Company& Value::getBusiness()
{
    return m_objectChoice.get<skipdict::values::Company>();
}

const skipdict::values::Company& Value::getBusiness() const
{
    return m_objectChoice.get<skipdict::values::Company>();
}

void Value::setBusiness(const skipdict::values::Company& business)
{
    m_objectChoice.set(business);
}

skipdict::values::RockBand& Value::getBand()
{
    return m_objectChoice.get<skipdict::values::RockBand>();
}

const skipdict::values::RockBand& Value::getBand() const
{
    return m_objectChoice.get<skipdict::values::RockBand>();
}

void Value::setBand(const skipdict::values::RockBand& band)
{
    m_objectChoice.set(band);
}

skipdict::values::BasketballTeam& Value::getTeam()
{
    return m_objectChoice.get<skipdict::values::BasketballTeam>();
}

const skipdict::values::BasketballTeam& Value::getTeam() const
{
    return m_objectChoice.get<skipdict::values::BasketballTeam>();
}

void Value::setTeam(const skipdict::values::BasketballTeam& team)
{
    m_objectChoice.set(team);
}

skipdict::values::CloudStorage Value::getStore() const
{
    return m_objectChoice.get<skipdict::values::CloudStorage>();
}

void Value::setStore(skipdict::values::CloudStorage store)
{
    m_objectChoice.set(store);
}
...
size_t Value::bitSizeOf(size_t _bitPosition) const
{
    ...
    switch (getCode())
    {
    case skipdict::values::ValueCode::COMPANY:
        _endBitPosition += m_objectChoice.get<skipdict::values::Company>().bitSizeOf(_endBitPosition);
        break;
    case skipdict::values::ValueCode::ROCK_BAND:
        _endBitPosition += m_objectChoice.get<skipdict::values::RockBand>().bitSizeOf(_endBitPosition);
        break;
    case skipdict::values::ValueCode::BASKETBALL_TEAM:
        _endBitPosition += m_objectChoice.get<skipdict::values::BasketballTeam>().bitSizeOf(_endBitPosition);
        break;
    case skipdict::values::ValueCode::CLOUD_STORAGE:
        _endBitPosition += m_objectChoice.get<skipdict::values::CloudStorage>().bitSizeOf(_endBitPosition);
        break;
    default:
...
size_t Value::initializeOffsets(size_t _bitPosition)
{
    ...
    {
    case skipdict::values::ValueCode::COMPANY:
        _endBitPosition = m_objectChoice.get<skipdict::values::Company>().initializeOffsets(_endBitPosition);
        break;
    case skipdict::values::ValueCode::ROCK_BAND:
        _endBitPosition = m_objectChoice.get<skipdict::values::RockBand>().initializeOffsets(_endBitPosition);
        break;
    case skipdict::values::ValueCode::BASKETBALL_TEAM:
        _endBitPosition = m_objectChoice.get<skipdict::values::BasketballTeam>().initializeOffsets(_endBitPosition);
        break;
    case skipdict::values::ValueCode::CLOUD_STORAGE:
        _endBitPosition = m_objectChoice.get<skipdict::values::CloudStorage>().initializeOffsets(_endBitPosition);
        break;
    default:
        throw zserio::CppRuntimeException("No match in choice Value!");
    }
...
int Value::hashCode() const
{
    ...
    _result = zserio::calcHashCode(_result, getCode());
...
void Value::read(zserio::BitStreamReader& _in)
{
    ...
    {
    case skipdict::values::ValueCode::COMPANY:
        m_objectChoice.reset(new (m_objectChoice.getResetStorage<skipdict::values::Company>())
                skipdict::values::Company(_in));
        break;
    case skipdict::values::ValueCode::ROCK_BAND:
        m_objectChoice.reset(new (m_objectChoice.getResetStorage<skipdict::values::RockBand>())
                skipdict::values::RockBand(_in));
        break;
    case skipdict::values::ValueCode::BASKETBALL_TEAM:
        m_objectChoice.reset(new (m_objectChoice.getResetStorage<skipdict::values::BasketballTeam>())
                skipdict::values::BasketballTeam(_in));
        break;
    case skipdict::values::ValueCode::CLOUD_STORAGE:
        m_objectChoice.reset(new (m_objectChoice.getResetStorage<skipdict::values::CloudStorage>())
                skipdict::values::CloudStorage(_in));
        break;
    default:
        throw zserio::CppRuntimeException("No match in choice Value!");
    }
...
void Value::write(zserio::BitStreamWriter& _out, zserio::PreWriteAction)
{
    ...
    {
    case skipdict::values::ValueCode::COMPANY:
        m_objectChoice.get<skipdict::values::Company>().write(_out, zserio::NO_PRE_WRITE_ACTION);
        break;
    case skipdict::values::ValueCode::ROCK_BAND:
        m_objectChoice.get<skipdict::values::RockBand>().write(_out, zserio::NO_PRE_WRITE_ACTION);
        break;
    case skipdict::values::ValueCode::BASKETBALL_TEAM:
        m_objectChoice.get<skipdict::values::BasketballTeam>().write(_out, zserio::NO_PRE_WRITE_ACTION);
        break;
    case skipdict::values::ValueCode::CLOUD_STORAGE:
        m_objectChoice.get<skipdict::values::CloudStorage>().write(_out, zserio::NO_PRE_WRITE_ACTION);
        break;
    default:
        throw zserio::CppRuntimeException("No match in choice Value!");
    }
